...
/**
 * @brief Lanza el código un montón de veces.
 * 
 * puede que e laparato no tenga precisión apra medir
 * un cronómetro mide de segundo en segundo. pero si quiero medir
 * un cuarto de segundo no puede medir, entonces da 0. entonces divido
 * para obtener los cuartos de segundo. 
 * 
 * El bucle 
 * 
 * @return int 
